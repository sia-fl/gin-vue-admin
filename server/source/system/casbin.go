...
func (c *casbin) Initialize() error {
	entities := []adapter.CasbinRule{
		...
		{PType: "p", V0: "1", V1: "/fileUploadAndDownload/findFile", V2: "GET"},
		{PType: "p", V0: "1", V1: "/fileUploadAndDownload/breakpointContinueFinish", V2: "POST"},
		{PType: "p", V0: "1", V1: "/fileUploadAndDownload/breakpointContinue", V2: "POST"},
		{PType: "p", V0: "1", V1: "/fileUploadAndDownload/removeChunk", V2: "POST"},
		...
		{PType: "p", V0: "1", V1: "/customer/customer", V2: "GET"},
		{PType: "p", V0: "1", V1: "/customer/customer", V2: "PUT"},
		{PType: "p", V0: "1", V1: "/customer/customer", V2: "POST"},
		{PType: "p", V0: "1", V1: "/customer/customer", V2: "DELETE"},
		{PType: "p", V0: "1", V1: "/customer/customerList", V2: "GET"},
		...
		{PType: "p", V0: "1", V1: "/excel/importExcel", V2: "POST"},
		{PType: "p", V0: "1", V1: "/excel/loadExcel", V2: "GET"},
		{PType: "p", V0: "1", V1: "/excel/exportExcel", V2: "POST"},
		{PType: "p", V0: "1", V1: "/excel/downloadTemplate", V2: "GET"},

		{PType: "p", V0: "2", V1: "/base/login", V2: "POST"},
		{PType: "p", V0: "2", V1: "/user/register", V2: "POST"},
		...
		{PType: "p", V0: "2", V1: "/customer/customer", V2: "POST"},
		{PType: "p", V0: "2", V1: "/customer/customer", V2: "PUT"},
		{PType: "p", V0: "2", V1: "/customer/customer", V2: "DELETE"},
		{PType: "p", V0: "2", V1: "/customer/customer", V2: "GET"},
		{PType: "p", V0: "2", V1: "/customer/customerList", V2: "GET"},
		{PType: "p", V0: "2", V1: "/user/getUserInfo", V2: "GET"},

		{PType: "p", V0: "3", V1: "/base/login", V2: "POST"},
		{PType: "p", V0: "3", V1: "/user/register", V2: "POST"},
		...
		{PType: "p", V0: "3", V1: "/fileUploadAndDownload/upload", V2: "POST"},
		{PType: "p", V0: "3", V1: "/fileUploadAndDownload/getFileList", V2: "POST"},
		{PType: "p", V0: "3", V1: "/fileUploadAndDownload/deleteFile", V2: "POST"},
		...
		{PType: "p", V0: "3", V1: "/customer/customer", V2: "PUT"},
		{PType: "p", V0: "3", V1: "/customer/customer", V2: "GET"},
		{PType: "p", V0: "3", V1: "/customer/customer", V2: "POST"},
		{PType: "p", V0: "3", V1: "/customer/customer", V2: "DELETE"},
		{PType: "p", V0: "3", V1: "/customer/customerList", V2: "GET"},
		{PType: "p", V0: "3", V1: "/autoCode/createTemp", V2: "POST"},
...
func (c *casbin) CheckDataExist() bool {
	if errors.Is(global.GVA_DB.Where(adapter.CasbinRule{PType: "p", V0: "3", V1: "GET", V2: "/user/getUserInfo"}).First(&adapter.CasbinRule{}).Error, gorm.ErrRecordNotFound) { // 判断是否存在数据
		return false
	}
	return true
}
